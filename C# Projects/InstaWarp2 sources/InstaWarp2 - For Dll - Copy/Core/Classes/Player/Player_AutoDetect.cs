namespace Core.Classes.Player
{
    ...
    public partial class Player
    {
        ...
        public  void ScanForPlayers()
        {
            ...
            {
                // Zone Id Exceptions..
                if (Globals.Instance.Stngs.ExcludedZones.Any(z => Convert.ToInt16(z) == currZone))
                    return;
            }
            ...
            if ((isZoning && currZone != 0) || CurrentZone == 0)
            {
                ...
                ZoneCooldown = Globals.Instance.Stngs.ZoneDelay;
            ...
            for (var x = 0; x < 4000; x++)
            {
                ...
                if (UseExclusions)
                {
                    ...
                    var foundExcludedPlayer = Globals.Instance.Stngs.ExcludedPlayers.Any(p => p.ToLower() == entityName.ToLower());
