...
function init_gear_sets()                                                       	
	...
	Argosy_body			={ name="Argosy Hauberk", augments={'STR+10','DEX+10','Attack+15',}}  
	...
	Valorous_head		={ name="Valorous Mask", augments={'Accuracy+21 Attack+21','"Store TP"+3','STR+10','Accuracy+7',}} -- 3 stp
	Valorous_body		={ name="Valorous Mail", augments={'Accuracy+24','"Store TP"+5','CHR+5','Attack+12',}} -- 8 stp
	Valorous_hands		={ name="Valorous Mitts", augments={'Accuracy+25 Attack+25','Weapon Skill Acc.+4','STR+8','Accuracy+10','Attack+4',}}
	Valorous_feet		={ name="Valorous Greaves", augments={'Accuracy+15 Attack+15','"Store TP"+8','Accuracy+5','Attack+14',}}  -- 13stp
	
	Emicho_hands		={ name="Emicho Gauntlets", augments={'HP+50','DEX+10','Accuracy+15',}}
	
	Odyssean_head_WS	={ name="Odyssean Helm", augments={'Weapon skill damage +4%','VIT+9','Accuracy+15','Attack+6',}}
	Odyssean_hands_WS	={ name="Odyssean Gauntlets", augments={'Accuracy+25 Attack+25','Weapon skill damage +4%','Accuracy+3',}}
	Odyssean_legs_WS	={ name="Odyssean Cuisses", augments={'Accuracy+22','Weapon skill damage +3%','STR+14','Attack+9',}} -- 5 stp
	Odyssean_legs_stp	={ name="Odyssean Cuisses", augments={'Accuracy+22 Attack+22','"Store TP"+5','DEX+10','Accuracy+14','Attack+14',}}
	
	Niht_back			={ name="Niht Mantle", augments={'Attack+15','"Drain" and "Aspir" potency +24','Weapon skill damage +2%',}}
	WS_back_reso		={ name="Ankou's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Crit.hit rate+10',}}
	WSD_back_STR		={ name="Ankou's Mantle", augments={'STR+19','Accuracy+20 Attack+20','STR+1','Weapon skill damage +10%',}}
	DA_back_STR			={ name="Ankou's Mantle", augments={'STR+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}}
	DA_back_DEX			={ name="Ankou's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10',}}
	STP_back_STR		={ name="Ankou's Mantle", augments={'STR+20','Accuracy+20 Attack+20','"Store TP"+10',}}
	
	CP_Cape				={ name="Mecisto. Mantle", augments={'Cap. Point+49%','"Mag.Atk.Bns."+2','DEF+2',}}
	
	AF_head 			={ name="Ignominy Burgonet +1" }
	AF_body				={ name="Ignominy Cuirass +1" }
	AF_hands 			={ name="Ignominy Gauntlets +1" }
	AF_legs 			={ name="Ignominy Flanchard +2" }
	AF_feet 			={ name="Ignominy Sollerets +1" }
    ...
    sets.precast.JA['Last Resort']  = {back=DA_back_STR}
	
	-- Fast cast sets for spells
	sets.precast.FC = {ammo="Impatiens",
			head=Carmine_head,neck="Incanter's Torque",ear1="Etiolation Earring",ear2="Loquac. Earring",
			body="Carmine scale mail",hands="Leyline gloves",ring1="Prolix Ring",ring2="Kishar Ring",
			back="",waist="",legs="Eschite Cuisses",feet=Carmine_feet}
	...
	sets.precast.WS['Resolution'] 					= set_combine(sets.precast.WS, {
			...
			head=Argosy_head,neck="Fotia Gorget",ear1="Brutal Earring",ear2=Moonshade_Ear,
			body=Argosy_body,hands=Argosy_hands,ring1="Ifrit Ring",ring2="Rufescent Ring +1",   -- 23 STP
			back=WS_back_reso,waist="Fotia Belt",legs=AF_legs,feet=Argosy_feet})
	...
	sets.midcast.Drain = set_combine(sets.midcast.FastRecast, {ammo="Knobkierrie",
			head=empty,neck="Erra Pendant",ear1="Gwati Earring",ear2="Dignitary's Earring",
			body="Lugra Cloak +1",hands=Relic_hands,ring1="Excelsis Ring",ring2="Evanescence Ring",
			back=Niht_back,waist="Austerity Belt +1",legs="Eschite Cuisses",})
	...
	sets.idle = {
									head=Empty,neck="Ganesha's Mala",ear1="Brutal Earring",ear2="Cessance Earring",
									body="Lugra Cloak +1",hands="Sulevia's gauntlets +1",ring1="Sheltered ring",ring2="Defending ring",
									back=DA_back_STR,waist="Flume belt +1",legs=Carmine_legs,feet=Valorous_feet}
	...
	sets.engaged 				= 	{ammo="Ginsen",
									head=Valorous_head,neck="Ganesha's Mala",ear1="Brutal Earring",ear2="Cessance Earring",
									body=Valorous_body,hands=Emicho_hands,ring1="Rajas ring",ring2="Petrov ring",
									back=DA_back_STR,waist="Windbuffet Belt +1",legs=Odyssean_legs_stp,feet=Valorous_feet}		-- 57 STP, 23% DA
	sets.engaged['Ilvl~118'] 	= set_combine(sets.engaged,				{neck="Lissome Necklace",waist="Ioskeha Belt"})
	sets.engaged['Ilvl~122'] 	= set_combine(sets.engaged['Ilvl~118'],	{ammo="Seething bomblet +1",neck="Combatant's torque",ear1="Dignitary's Earring",})
	sets.engaged['Ilvl~124+'] 	= set_combine(sets.engaged['Ilvl~122'],	{ammo="Ginsen",
																		head=Carmine_head,ear2="Zennaroi Earring",
																		body="Emicho Haubert",
																		waist="Olseni Belt",legs=Carmine_legs})
	...
	sets.engaged['Ilvl~118']['H: 908+']		= set_combine(sets.engaged['H: 908+'],				{neck="Lissome Necklace",waist="Ioskeha Belt"})
	sets.engaged['Ilvl~122']['H: 908+'] 	= set_combine(sets.engaged['Ilvl~118']['H: 908+'],	{ammo="Seething bomblet +1",neck="Combatant's torque",ear1="Dignitary's Earring",})
	sets.engaged['Ilvl~124+']['H: 908+'] 	= set_combine(sets.engaged['Ilvl~122']['H: 908+'],	{ammo="Ginsen",
	                                                                                            head=Carmine_head,ear2="Zennaroi Earring",
	                                                                                            body="Emicho Haubert",
	                                                                                            waist="Olseni Belt",legs=Carmine_legs})
	-- Sub SAM sets
	...
	sets.engaged['Greatsword'] 					= set_combine(sets.engaged,	{})		-- 57 STP, 23% DA
	sets.engaged['Greatsword']['Ilvl~118'] 		= set_combine(sets.engaged['Greatsword'],				{
														neck="Lissome Necklace",waist="Ioskeha Belt"})
	sets.engaged['Greatsword']['Ilvl~122'] 		= set_combine(sets.engaged['Greatsword']['Ilvl~118'],	{
														ammo="Seething bomblet +1",neck="Combatant's torque",ear1="Dignitary's Earring",})
	...
	sets.engaged['Apocalypse']['Ilvl~118'] 		= set_combine(sets.engaged,				{})
	sets.engaged['Apocalypse']['Ilvl~122'] 		= set_combine(sets.engaged['Ilvl~118'],	{})
	sets.engaged['Apocalypse']['Ilvl~124+'] 	= set_combine(sets.engaged['Ilvl~122'],	{})
