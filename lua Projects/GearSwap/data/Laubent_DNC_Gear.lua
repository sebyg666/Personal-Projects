...
function init_gear_sets()
	...
	HercWSHead	= { name="Herculean Helm", augments={'Weapon skill damage +4%','AGI+9'}}
    HercDTHead 	= { name="Herculean Helm", augments={'Accuracy+22 Attack+22','"Dual Wield"+1','MND+4','Accuracy+10','Attack+14'}}
    HercDTHands	= { name="Herculean Gloves", augments={'Attack+17','Damage taken-4%'}}
    HercDTFeet 	= { name="Herculean Boots", augments={'Accuracy+11','Weapon skill damage +4%','AGI+4','Attack+15'}}
	...
	BackDD 			= { name="Senuna's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10'}}
    BackWS 			= { name="Senuna's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%'}}
	...
	sets.precast.Samba = {head= AF_head}
	...
	sets.precast.Step = {
		head=AF_head,neck="Asperity Necklace",left_ear="Digni. Earring",right_ear="Moonshade Earring",
	...
	sets.precast.WS = { ammo="",
		head=HercWSHead, neck="Caro Necklace", left_ear="Digni. Earring", right_ear= gear.ws_ear, 
	...
	sets.precast.WS["Pyrrhic Kleos"] 					= set_combine(sets.precast.WS, {
															head=Adhemar_head,neck="Fotia Gorget",left_ear="Steelflash Earring",right_ear="Bladeborn Earring", 
															body=Adhemar_body,hands=AF_hands,left_ring="Epona's Ring",right_ring="Petrov Ring",
	...
	sets.engaged['Ilvl~118']['AM3']			= set_combine(sets.engaged['AM3'], 				{})
	sets.engaged['Ilvl~122']['AM3']			= set_combine(sets.engaged['Ilvl~118']['AM3'], 	{})
