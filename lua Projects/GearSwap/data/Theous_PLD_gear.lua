...
function init_gear_sets()
	...
	Eschite_feet			={ name="Eschite Greaves"	}
	...
	-- Default set for any weaponskill that isn't any more specifically defined
		...
		body="Sulevia's platemail",hands=Odyss_hands_acc,ring1="Petrov Ring",ring2="Rajas Ring",
    ...
    sets.midcast.Cure 						= set_combine(sets.precast.Enmity,  {neck="Homeric Gorget",ear1="Nourishing Earring +1",ear2="Mendicant's Earring",legs=Odyss_legs_acc})
	sets.midcast.Cure.SIRD 				= set_combine(sets.midcast.Cure, sets.SIRD)

	sets.midcast.CureSelf 					= set_combine(sets.midcast.Cure, {ear2="Oneiros Earring",legs=Souveran_legs_HQ,feet=Souveran_feet_HQ} )
	...
	sets.midcast['Phalanx'] 						= set_combine(sets.midcast['Enhancing magic'], {back=Weard_back,feet=Souveran_feet_HQ})
	...
	sets.idle = {ammo="Brigantia Pebble",
		head=AF_head,neck="Coatl Gorget +1",ear1="Infused Earring",ear2="Merman's Earring",
