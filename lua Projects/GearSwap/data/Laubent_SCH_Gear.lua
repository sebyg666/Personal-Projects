...
function init_gear_sets()
	...
	Death_Staff			={ name="Grioavolr", augments={'Magic burst mdg.+10%','MP+65','Mag. Acc.+18','"Mag.Atk.Bns."+25',}}
	
	Merl_head_Burst		={ name="Merlinic Hood", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','Magic burst mdg.+10%','VIT+6','Mag. Acc.+13','"Mag.Atk.Bns."+15',}}
    Merl_legs_Burst		={ name="Merlinic Shalwar", augments={'Mag. Acc.+16 "Mag.Atk.Bns."+16','Magic burst mdg.+4%','AGI+10','Mag. Acc.+9','"Mag.Atk.Bns."+14',}}
	Merl_feet_Burst		={ name="Merlinic Crackows", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','Magic burst mdg.+5%','INT+4',}}
	...
	Amalric_feet		={ name="Amalric Nails", augments={'MP+60','Mag. Acc.+15','"Mag.Atk.Bns."+15',}}
    ...
    sets.precast.FC = {main=gear.FastcastStaff,sub={name="Clerisy Strap",priority=-1},ammo="Impatiens",
        head=Merl_head_FC,neck="Voltsurge Torque",ear1="Loquac. Earring",ear2="Etiolation Earring",
		body="Anhur Robe",ring1="Prolix Ring",ring2="Rahab Ring",
	...
	sets.midcast['Elemental Magic'] = {
        ...
        back=Taranus_back,waist=gear.ElementalObi,legs=Merl_legs_Burst,feet=Merl_feet_Burst}
	...
	sets.midcast['Death'] = {
        ...
        body=Merl_body_Burst,hands=Amalric_hands,ring1="Archon Ring", ring2="Mephitas's Ring +1",
        back=Taranus_back,waist=gear.ElementalObi,legs=Amalric_legs,feet=Merl_feet_Burst}
    ...
    sets.idle = {main=Death_Staff, sub={name="Niobid Strap",priority=-1},
        ...
        back="Solemnity Cape",waist="Witful Belt",legs="Assiduity Pants +1",feet="Serpentes Sabots"}
