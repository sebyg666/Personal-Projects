...
function init_gear_sets()
	...
	print('Laubent_THF_Gear.lua sidecar load')

	--------------------------------------
	-- Augemnted Gear
	--------------------------------------	
	
	Adhemar_head		={ name="Adhemar Bonnet +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
    Adhemar_body		={ name="Adhemar Jacket +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
	Adhemar_hands		={ name="Adhemar Wrist. +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
	...
	Herc_body_TP_TA		={ name="Herculean Vest", augments={'Accuracy+25 Attack+25','"Triple Atk."+2','Accuracy+9',}}
	...
	Herc_feet_TP_TA		={ name="Herculean Boots", augments={'Accuracy+24','"Triple Atk."+4','STR+5','Attack+5',}}
	...
	TP_Back				={ name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10',}}
	WS_back				={ name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}}
	
	Moonshade_Ear		={ name="Moonshade Earring", augments={'Attack+4','TP Bonus +25',}}
	
	AF_head             ={name="Pillager's bonnet +2"}
	AF_body             ={name="Pillager's vest +2"}
	AF_hands            ={}
	AF_legs             ={name="Pillager's culottes +2"}
	AF_feet             ={}
    ...
    sets.buff['Sneak Attack'] = {
		...
		body="Meghanada Cuirie +1",hands=Adhemar_hands,ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
    ...
    sets.precast.FC = {ammo="Impatiens",
		head=Herc_head_FC,neck="Voltsurge Torque",ear1="Loquacious Earring",ear2="Etiolation Earring",
		body="Foppish Tunica",hands=Leyline_Gloves,ring1="Rahab Ring",ring2="Prolix Ring",
		legs=Rawhide_legs,feet=Herc_feet_FC}

    sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, {neck="Magoraga Beads"})

    -- Ranged snapshot gear
    sets.precast.RA = {head="Aurore Beret +1",hands="Alruna's Gloves +1",waist="Impulse Belt",legs=Adhemar_legs,feet='Meghanada Jambeaux +1'}
	----------------------
    -- Weaponskill sets
	----------------------
    ...
    sets.precast.WS = {
		ammo="Yetshila",
		head=Adhemar_head,neck=gear.ElementalGorget,ear1="Ishvara Earring",ear2="Sherida Earring",
		body=Adhemar_body,hands="Meghanada Gloves +2",ring1="Epona's Ring",ring2="Ilabrat Ring",
		back=WS_back,waist=gear.ElementalBelt,legs=Samnuha_Tights,feet=Herc_feet_WSD}
	...
	sets.precast.WS['Exenterator'] 					= set_combine(sets.precast.WS, {ammo="Seething Bomblet +1",
																					...
																					body="Meghanada Cuirie +1",hands="Meghanada Gloves +2",ring1="Garuda Ring",ring2="Garuda Ring",
																					back=WS_back,waist=gear.ElementalBelt,legs="Meghanada Chausses +1",feet="Meghanada Jambeaux +1"})
	...
	----------------------------------------------------------------------------------------------------------------------------------------------------------
	sets.precast.WS["Rudra's Storm"] 					= set_combine(sets.precast.WS, {neck="Caro Necklace",ear1="Ishvara Earring",head=AF_head,ear2="Sherida Earring",
																						body=AF_body,ring1="Ramuh Ring +1",ring2="Ilabrat Ring",
																						waist="Grunfeld Rope",legs=Lustratio_legs,feet=Herc_feet_WSD}) -- herc hands body head with dex acc att WSD
    ...
    sets.precast.WS["Rudra's Storm"].SA 				= set_combine(sets.precast.WS["Rudra's Storm"], {neck="Caro Necklace",ear1="Ishvara Earring",ear2="Sherida Earring",
																										body=AF_body,ring1="Ramuh Ring +1",ring2="Ilabrat Ring",
																										waist="Grunfeld Rope",legs=Lustratio_legs,feet=Herc_feet_WSD})
	...
	sets.precast.WS['Mandalic Stab'] 					= set_combine(sets.precast.WS, {ammo="Seething Bomblet +1",
																						...
																						body="Meghanada Cuirie +1",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
	...
	sets.precast.WS['Aeolian Edge'] = {
		...
		body=Herc_body_MAB_WS,hands="Meghanada Gloves +2",ring1="Ramuh Ring +1",ring2="Petrov Ring",
		back="Aput Mantle",waist="Eschan Stone",legs=Herc_legs_MAB_WS,feet=Herc_feet_MAB_WS}
    ...
    sets.midcast.Utsusemi = {
        head=Herc_head_FC,ear1="Loquacious Earring",ear2="Etiolation Earring",
		body="Foppish Tunica",ring1="Rahab Ring",ring2="Prolix Ring",
		legs=Rawhide_legs,feet=Herc_feet_FC} 
    ...
    sets.idle = {
		...
		body="Meghanada Cuirie +1",hands="Meghanada Gloves +2",ring1="Sheltered Ring",ring2="Chirich Ring",
		back='Solemnity Cape',waist="Flume Belt +1",legs="Meghanada Chausses +1",feet="Fajin Boots"}

    sets.idle.Weak = {
		head="Meghanada Visor +1",neck="Loricate Torque +1",ear1="Dawn Earring",ear2="Infused Earring",
		body="Meghanada Cuirie +1",hands="Meghanada Gloves +2",ring1="Sheltered Ring",ring2="Paguroidea Ring",
		back='Solemnity Cape',waist="Flume Belt +1",legs="Meghanada Chausses +1",feet=Herc_feet_TP_Acc}
    ...
    sets.defense.PDT = {
		...
		back="Solemnity Cape",ammo="Staunch Tathlum",waist="Flume Belt +1",legs='Meghanada Chausses +1',feet=Herc_feet_TP_Acc}

    sets.defense.MDT = {
		head=Dampening_Tam,neck="Loricate Torque +1",ear1="Etiolation earring",ear2="Merman's earring",
		body=Adhemar_body,hands='Kurys Gloves',ring1="Vocane Ring",ring2="Defending Ring",
		back="Engulfer Cape +1",ammo="Staunch Tathlum", waist="Flume Belt +1",legs='Meghanada Chausses +1',feet=Herc_feet_TP_Acc}
	...
	sets.engaged 				= {ammo="Yamarang",
								head=Adhemar_head,neck="Erudition Necklace",ear1="Sherida Earring",ear2="Telos Earring",
								body=AF_body,hands=Adhemar_hands,ring1="Epona's Ring",ring2="Petrov Ring",
								back=TP_back,waist="Windbuffet Belt +1",legs=Samnuha_Tights,feet=Herc_feet_TP_Acc}
    sets.engaged['Ilvl~118'] 	= set_combine(sets.engaged, 			{})
	sets.engaged['Ilvl~122'] 	= set_combine(sets.engaged['Ilvl~118'], {ring1="Moonbeam Ring",ring2="Moonbeam Ring"})
	...
	sets.engaged['DW: 37+'] 				= set_combine(sets.engaged, 						{ammo="Yamarang",
																								head=Adhemar_head,neck="Erudition Necklace",ear1="Eabani Earring",ear2="Telos Earring",
																								body=AF_body,hands=Adhemar_hands,ring1="Epona's Ring",ring2="Petrov Ring",
																								back=TP_Back,waist="Reiki Yotai",legs=Samnuha_Tights,feet=Herc_feet_TP_TA})
	sets.engaged['Ilvl~118']['DW: 37+']		= set_combine(sets.engaged['DW: 37+'], 				{ring2="Moonbeam Ring",legs=AF_legs,legs=AF_legs,})
	sets.engaged['Ilvl~122']['DW: 37+'] 	= set_combine(sets.engaged['Ilvl~118']['DW: 37+'], 	{head=AF_head,})
	...
	sets.engaged['DW: 6-11'] 				= set_combine(sets.engaged['DW: 37+'] , 				{ear1="Sherida Earring",ear2="Telos Earring",
																									hands=Adhemar_hands,
																									back=TP_Back,waist="Windbuffet Belt +1"})
	...
	sets.engaged['Ilvl~122']['DW: 5-0'] 	= set_combine(sets.engaged['Ilvl~118']['DW: 5-0'], 	{body="Meg. Cuirie +1",head=Dampening_Tam,ring1="Ramuh Ring +1",})
	...
	sets.crafting = {head="Shaded Spectacles",body="Goldsmith's Smock",neck="Goldsmith's Torque",ring1="Orvail Ring",ring2="Craftmaster's Ring",}
