...
print('Spyderhawk_Globals.lua Loaded')
...
function define_global_sets()
	...
	--Dark Rings
	--gear.DarkRing = {}
	--gear.DarkRing.dt = { name="Dark Ring", augments={'Spell interruption rate down -3%','Magic dmg. taken -5%','Phys. dmg. taken -5%',}}
...
function binds_on_load()
	...
	send_command('track clear;wait 0.3;track add Inv: ${INVENTORY:$FREESPACE}')
