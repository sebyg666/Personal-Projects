function get_sets()
    ...
    STR      = {head="Rao Kabuto",neck="fotia gorget",ear1="flame pearl",ear2="flame pearl",
               body="Bhikku Cyclas +1",hands="Ryuo tekko",ring1="Ifrit ring",
               ring2="Ifrit ring",waist="fotia Belt",legs="samnuha tights",feet="Rao sune-ate",
               back="Buquwik Cape"}
   ...
   -- DDBody  = {name = "qaaxo harness",  augments={"Attack+15"}}
    ...
    DD      = {main="fleshcarvers",head="Dampening tam",neck="asperity necklace",
               ear2="steelflash earring",ear1="bladeborn earring",body="Bhikku Cyclas +1",hands=DDHands,
               ring1="Epona's Ring",ring2="petrov ring",waist="cetl belt",
               legs="samnuha tights",feet=DDFeet,back="Atheling Mantle"}

    DDACC    = {main="condemners",head="Rao Kabuto",neck="asperity necklace",ear2="steelflash earring",
               ear1="bladeborn earring",body="Bhikku Cyclas +1",hands="Ryuo tekko",
               ring1="rajas ring",ring2="petrov ring",waist="cetl belt",
               legs="Ryuo hakama",feet="Valorous greaves",back="anchoret's mantle"}


    ACC     = {main="condemners",head="Rao Kabuto",neck="subtlety spectacles",
               ear1="zennaroi earring",ear2="steelflash earring",body="samnuha coat",
               hands="Ryuo tekko",ring1="Raumh ring",ring2="enlivened ring",
               legs="Ryuo hakama",feet="Rao sune-ate",back="anchoret's mantle",waist="olseni belt"}
    ...
    PDT     = {main="oatixur",head=PDTHead,neck="Twilight torque",body="emet harness +1",
...
function AutoBuffs()
    if AutoMode == true then
        ...
        if player.status == "Engaged" and not midaction() then 
            ...
            elseif not buffactive.hasso and spell_recasts[Focus] < 1 then 
               send_command('input /ja Focus <me>;')
            elseif not buffactive.hasso and spell_recasts[Dodge] < 1 then 
               send_command('input /ja Dodge <me>;')
            elseif not buffactive.hasso and spell_recasts[Counterstance] < 1 and CounterStanceMode then 
               send_command('input /ja Counterstance <me>;')
            elseif not buffactive.hasso and spell_recasts[Impetus] < 1 then 
