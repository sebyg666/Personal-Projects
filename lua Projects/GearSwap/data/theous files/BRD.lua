...
function user_setup()
    ...
    send_command('bind ^` input /ma "Chocobo Mazurka" <me>')
    send_command('bind = input /equip ring1 "Warp Ring"')
    send_command('bind ^= input /item "Warp Ring" <me>')
...
function init_gear_sets()
    ...
    sets.midcast.Madrigal = {head="Fili Calot", back="Intarabus's Cape"}
    ...
    sets.midcast.SongEffect = {main={ name="Kali", augments={'Mag. Acc.+15','String instrument skill +10','Wind instrument skill +10',}},Sub="Ammurapi Shield",range="Gjallarhorn",
        head="Fili Calot",body="Fili Hongreline",neck="Moonbow Whistle",ear1="Aoidos' Earring",ear2="Loquac. Earring",
        hands="Gendewitha Gages +1",ring1="Stikini Ring",ring2="Weather. Ring",
        back="Intarabus's Cape",waist="Witful Belt",legs="Inyanga Shalwar +1",feet="Brioso Slippers",}

    -- For song defbuffs (duration primary, accuracy secondary)
    sets.midcast.SongDebuff = {
	    main={ name="Kali", augments={'Mag. Acc.+15','String instrument skill +10','Wind instrument skill +10',}},Sub="Ammurapi Shield",range="Gjallarhorn",
        head="Brioso Roundlet",neck="Moonbow Whistle",ear1="Regal Earring",ear2="Enchntr. Earring +1",
        body="Fili Hongreline",hands="Fili Manchettes",ring1="Stikini Ring",ring2="Weather. Ring",
        back="Intarabus's Cape",waist="Luminary Sash",legs="Inyanga Shalwar +1",feet="Brioso Slippers"}
    ...
    sets.midcast.DaurdablaDummy = {
        range="Terpander",main={ name="Kali", augments={'Mag. Acc.+15','String instrument skill +10','Wind instrument skill +10',}},Sub="Ammurapi Shield",range=info.ExtraSongInstrument,
        head="Fili Calot",neck="Aoidos' Matinee",ear1="Aoidos' Earring",ear2="Loquac. Earring",
        hands="Gendewitha Gages +1",ring1="Kishar Ring",ring2="Weather. Ring",
...
--[[
	...
	-- COMMENTED OUT FOR TESTING PURPOSES. WANT TO PLAY 3 DUMMY SONGS TO BEGIN WITH, THEN 3 FULLY BUFFED SONGS 
