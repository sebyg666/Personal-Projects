...
function init_gear_sets()
	...
	Adhemar_hands_Att	={ name="Adhemar Wristbands", augments={'STR+10','DEX+10','Attack+15',}}
	
	Adhemar_head_Acc	={ name="Adhemar Bonnet +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
    Adhemar_body_Acc	={ name="Adhemar Jacket +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
	Adhemar_hands_Acc	={ name="Adhemar Wrist. +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
	...
	Dampening_Tam	={ name="Dampening Tam", augments={'DEX+8','Accuracy+14','Mag. Acc.+13','Quadruple Attack +1',}}
	...
	Herc_body_TA	={ name="Herculean Vest", augments={'Accuracy+25 Attack+25','"Triple Atk."+2','Accuracy+9',}}
	...
	Herc_feet_TA	={ name="Herculean Boots", augments={'Accuracy+24','"Triple Atk."+4','STR+5','Attack+5',}}
	
	Herc_legs_DW	={ name="Herculean Trousers", augments={'Accuracy+25','"Dual Wield"+4','STR+10','Attack+14',}}
	
	Herc_head_WSD	={ name="Herculean Helm", augments={'Accuracy+18 Attack+18','Weapon skill damage +3%','Accuracy+4',}}
	Herc_body_WSD	={ name="Herculean Vest", augments={'Accuracy+22','Weapon skill damage +4%','DEX+12','Attack+9',}}
	Herc_hands_WSD	={ name="Herculean Gloves", augments={'Accuracy+13 Attack+13','Weapon skill damage +3%','STR+8','Attack+2',}}
    Herc_legs_WSD	={ name="Herculean Trousers", augments={'Accuracy+13 Attack+13','Weapon skill damage +3%','STR+8','Attack+2',}}
    Herc_feet_WSD	={ name="Herculean Boots", augments={'Accuracy+30','Weapon skill damage +5%','Attack+13',}}
	
	Herc_body_TA_STR	={ name="Herculean Vest", augments={'Accuracy+25 Attack+25','"Triple Atk."+2','Accuracy+9',}}
	Herc_feet_TA_STR	={ name="Herculean Boots", augments={'Accuracy+24','"Triple Atk."+4','STR+5','Attack+5',}}
	...
	Herc_head_DT	={ name="Herculean Helm", augments={'Accuracy+10','Damage taken-4%','STR+4',}}
	Herc_hands_DT	={ name="Herculean Gloves", augments={'Accuracy+21','Damage taken-2%','DEX+9',}}
	...
	Herc_hands_Refr	={ name="Herculean Gloves", augments={'INT+3','Accuracy+9 Attack+9','"Refresh"+1','Mag. Acc.+1 "Mag.Atk.Bns."+1',}}
	Herc_feet_Refr	={ name="Herculean Boots", augments={'Pet: DEX+7','Magic dmg. taken -2%','"Refresh"+1','Accuracy+16 Attack+16','Mag. Acc.+18 "Mag.Atk.Bns."+18',}}
	
	AF_head 		={ name="Runeist's Bandeau +2" }
	AF_body			={ name="Runeist's Coat +2" }
	AF_hands 		={ name="Runeist's Mitons +2" }
	AF_legs 		={ name="Runeist's Trousers +2" }
	AF_feet 		={ name="Runeist's Bottes +2" }
    ...
    Relic_hands		={ name="Futhark Mitons +1", augments={'Enhances "Sleight of Sword" effect',}}
	Relic_legs		={ name="Futhark Trousers +1", augments={'Enhances "Inspire" effect',}}
	Relic_feet		={ name="Futhark Boots +1", augments={'Enhances "Rayke" effect',}}
	...
	Evasionist_back	={ name="Evasionist's Cape", augments={'Enmity+1','"Embolden"+8','"Dbl.Atk."+1','Damage taken-3%',}}
	TP_back			={ name="Ogma's cape", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10',}}
	...
	gear.Max_TP_Ear = {name="Telos Earring"}
	gear.ws_ear = {name="Telos Earring"}
	...
	sets.precast.JA['Provoke'] = {ammo="Sapience Orb",
		...
		back="Reiki Cloak",waist="Kasiri Belt",legs=Empy_legs,feet=Empy_feet}
	...
	sets.precast.JA['Lunge'] = {ammo='Ghastly Tathlum',
								...
								body=Samnuha_Coat,hands=Carmine_hands_HQ,
    ...
    sets.precast.WS = {
		ammo="Knobkierrie",
		head=Adhemar_head_Att,neck="Fotia Gorget",ear1="Sherida Earring",ear2="Ishvara Earring",
		body="Ashera harness",hands="Meghanada Gloves +2",ring1="Ifrit Ring +1",ring2="Niqmaddu Ring",
	...
	sets.precast.WS['Dimidiation']				= set_combine(sets.precast.WS, {
		...
		body=Herc_body_WSD,hands="Meghanada Gloves +2",ring1="Ilabrat Ring",ring2="Epona's Ring",
	...
	sets.midcast['Enhancing Magic'] = set_combine(sets.midcast.FastRecast, {head=Empy_head,hands="Regal gauntlets",ear1="Andoaa Earring",
    ...
    sets.resting = {ammo="Brigantia Pebble",
		...
		body="Emet Harness +1",hands="Reagal gauntlets",ring1="Chirich Ring",ring2="Sheltered Ring",
		back=Evasionist_back,waist="Flume Belt +1",legs=Rawhide_legs,feet=Herc_feet_Refr}
    
    -- Idle sets
    sets.idle = {ammo="Staunch Tathlum",
        head="Rawhide Mask",neck="Sanctity Necklace",ear1="Dawn Earring",ear2="Infused Earring",
		body="Ashera harness",hands="Regal gauntlets",ring1="Chirich Ring",ring2="Sheltered Ring",
		back=Evasionist_back,waist="Flume Belt +1",legs=Carmine_legs_HQ,feet=Herc_feet_Refr}
    ...
    sets.idle.PDT = {ammo="Staunch Tathlum",
        head=Herc_head_DT,neck="Loricate Torque +1",ear1="Odnowa Earring",ear2="Infused Earring",
		body="Ashera harness",hands=Herc_hands_DT,ring1="Defending Ring",ring2="Vocane Ring",
		back=Evasionist_back,waist="Flume Belt +1",legs=Empy_legs,feet=Empy_feet}
		
	sets.idle.Weak = {ammo="Staunch Tathlum",
        head="Rawhide Mask",neck="Sanctity Necklace",ear1="Odnowa Earring",ear2="Infused Earring",
		body=Relic_body,hands=Herc_hands_DT,ring1="Defending Ring",ring2="Vocane Ring",
		back=Evasionist_back,waist="Flume Belt +1",legs=Rawhide_legs,feet=Herc_feet_Refr}
	...
	sets.StatRes = {ammo="Staunch Tathlum",
        head=Herc_head_DT,neck="Loricate Torque +1",ear1="Odnowa Earring",ear2="Hearty Earring",
		body=Empy_body,hands=Empy_hands,ring1="Defending Ring",ring2="Warden's Ring",
		back=Evasionist_back,waist="Flume Belt +1",legs=AF_legs,feet=Empy_feet}
    ...
    sets.defense.PDT = {ammo="Staunch Tathlum",
		...
		body="Ashera harness",hands="Regal gauntlets",ring1="Defending Ring",ring2="Vocane Ring",
		back=TP_back,waist="Flume Belt +1",legs=Empy_legs,feet=Empy_feet}

    sets.defense.MDT = {ammo="Vanir Battery",
        head=Empy_head,neck="Inq. Bead Necklace",ear1="Etiolation Earring",ear2="Odnowa Earring +1",
		body="Ashera harness",hands=Empy_hands,ring1="Defending Ring",ring2="Vocane Ring",
	...
	sets.engaged 					= {ammo="Yamarang",  --main="Aettir",sub="Utu grip",
										head=Adhemar_head_Acc,neck="Anu Torque",ear1="Dedition Earring",ear2="Telos Earring",
										body="Ashera harness",hands="Regal gauntlets",ring1="Petrov Ring",ring2="Epona's Ring",
	...
	sets.engaged['Ilvl~124+'] 		= set_combine(sets.engaged['Ilvl~122'], 	{ammo="Falcon Eye",neck="Ej Necklace",ear2="Telos Earring",legs=Carmine_legs_HQ})

			sets.engaged['SAM'] 				= {ammo="Yamarang",  --main="Aettir",sub="Utu grip",
													head=Adhemar_head_Acc,neck="Anu Torque",ear1="Sherida Earring",ear2="Telos Earring",
													body=Herc_body_TA,hands="Regal gauntlets",ring1="Petrov Ring",ring2="Epona's Ring",
			...
			sets.engaged['SAM']['Ilvl~124+'] 	= set_combine(sets.engaged['SAM']['Ilvl~122'], 	{ammo="Falcon Eye",neck="Ej Necklace",ear2="Telos Earring",legs=Carmine_legs_HQ})
	
	-- Hybrid DT set
	sets.engaged.DT 				= {ammo="Staunch Tathlum", -- main="Aettir",sub="Utu grip",
										head=Herc_head_DT,neck="Loricate Torque +1",ear1="Dedition Earring",ear2="Telos Earring",
										body="Ashera harness",hands=Adhemar_hands,ring1="Defending Ring",ring2="Epona's Ring",
	...
	sets.engaged['Ilvl~124+'].DT 	= set_combine(sets.engaged['Ilvl~122'].DT, 	{ammo="Falcon Eye",neck="Ej Necklace",ear2="Telos Earring",legs=Carmine_legs_HQ})
			...
			sets.engaged['SAM']['Ilvl~124+'].DT 	= set_combine(sets.engaged['SAM']['Ilvl~122'].DT, 	{ammo="Falcon Eye",neck="Ej Necklace",ear2="Telos Earring",legs=Carmine_legs_HQ})
						
				
	-- Hybrid DT set
	sets.engaged.Tank 					= {main="Lionheart",sub="Utu grip",ammo="Staunch Tathlum",  --main="Aettir",sub="Utu grip",
	...
	sets.engaged['Ilvl~124+'].Tank 		= set_combine(sets.engaged['Ilvl~122'].Tank, 	{})
			...
			sets.engaged['SAM'].Tank 					= {main="Lionheart",sub="Utu grip",ammo="Staunch Tathlum",  --main="Aettir",sub="Utu grip",
															head=Herc_head_DT,neck="Loricate Torque +1",ear1="Odnowa Earring",ear2="Odnowa Earring +1",
															body="Ashera harness",hands="Regal gauntlets",ring1="Defending Ring",ring2="Warden's Ring",
															back=TP_back,waist="Flume Belt +1",legs=Empy_legs,feet=Empy_feet}
	...
	sets.engaged['Lionheart'] 					= {ammo="Yamarang",
													head=Adhemar_head_Acc,neck="Ainia Collar",ear1="Sherida Earring",ear2="Telos Earring",
													body="Ashra harness",hands=Adhemar_hands_Acc,ring1="Pernicious Ring",ring2="Niqmaddu Ring",
													back=TP_back,waist="Windbuffet Belt +1",legs=Samnuha_Tights,feet=Herc_feet_TA}
	...
	sets.engaged['Lionheart']['Ilvl~124+'] 		= set_combine(sets.engaged['Lionheart']['Ilvl~122'], 	{ammo="Falcon Eye",neck="Ej Necklace",ear2="Telos Earring",legs=Carmine_legs_HQ})

			sets.engaged['SAM']['Lionheart'] 				= set_combine(sets.engaged, {ammo="Yamarang",
																head=Adhemar_head_Acc,neck="Sanctity necklace",ear1="Sherida Earring",ear2="Telos Earring",
																body="Ashera harness",hands=Adhemar_hands,ring1="Epona's Ring",ring2="Niqmaddu Ring",
																back=TP_back,waist="Windbuffet Belt +1",legs=Samnuha_Tights,feet=Herc_feet_TA})
			sets.engaged['SAM']['Lionheart']['Ilvl~118']	= set_combine(sets.engaged['SAM']['Lionheart'], 				{head=Carmine_head_HQ,waist="Grunfeld Rope"})
			sets.engaged['SAM']['Lionheart']['Ilvl~122']	= set_combine(sets.engaged['SAM']['Lionheart']['Ilvl~118'], 	{ear1="Cessance Earring"})
			sets.engaged['SAM']['Lionheart']['Ilvl~124+'] 	= set_combine(sets.engaged['SAM']['Lionheart']['Ilvl~122'], 	{legs=Carmine_legs_HQ,ring1="Moonbeam Ring",ring2="Moonbeam Ring"})
	
	-- Hybrid DT set
	sets.engaged['Lionheart'].DT 					= {ammo="Staunch Tathlum",
														head=Herc_head_DT,neck="Loricate Torque +1",ear1="Sherida Earring",ear2="Telos Earring",
														body="Ashera harness",hands=Adhemar_hands,ring1="Defending Ring",ring2="Niqmaddu Ring",
														back=TP_back,waist="Windbuffet Belt +1",legs=Empy_legs,feet=Herc_feet_TA}
	sets.engaged['Lionheart']['Ilvl~118'].DT		= set_combine(sets.engaged['Lionheart'].DT, 				{head=Carmine_head_HQ,waist="Grunfeld Rope"})
	sets.engaged['Lionheart']['Ilvl~122'].DT		= set_combine(sets.engaged['Lionheart']['Ilvl~118'].DT, 	{neck="Sanctity Necklace"})
	sets.engaged['Lionheart']['Ilvl~124+'].DT 		= set_combine(sets.engaged['Lionheart']['Ilvl~122'].DT, 	{ammo="Falcon Eye",neck="Ej Necklace",ear2="Telos Earring",legs=Carmine_legs_HQ})
			...
			sets.engaged['SAM']['Lionheart']['Ilvl~124+'].DT 	= set_combine(sets.engaged['SAM']['Lionheart']['Ilvl~122'].DT, 	{ammo="Falcon Eye",neck="Ej Necklace",ear2="Telos Earring",legs=Carmine_legs_HQ})
						
				
	-- Hybrid DT set
	sets.engaged['Lionheart'].Tank 					= {main="Lionheart",sub="Utu grip",ammo="Staunch Tathlum",  --main="Aettir",sub="Utu grip",
														head=Herc_head_DT,neck="Loricate Torque +1",ear1="Sherida Earring",ear2="Odnowa Earring +1",
														body="Ashera harness",hands=Herc_hands_DT,ring1="Defending Ring",ring2="Vocane Ring",
														back=TP_back,waist="Flume Belt +1",legs=Empy_legs,feet=Empy_feet}
	...
	sets.engaged['Lionheart']['Ilvl~124+'].Tank		= set_combine(sets.engaged['Lionheart']['Ilvl~122'].Tank, 	{})
			...
			sets.engaged['SAM']['Lionheart'].Tank 					= {main="Lionheart",sub="Utu grip",ammo="Staunch Tathlum",  --main="Aettir",sub="Utu grip",
																		head=Herc_head_DT,neck="Loricate Torque +1",ear1="Ethereal Earring",ear2="Odnowa Earring +1",
																		body="Ashera harness",hands=Herc_hands_DT,ring1="Defending Ring",ring2="Vocane Ring",
																		back=TP_back,waist="Flume Belt +1",legs=Empy_legs,feet=Empy_feet}
	...
	sets.engaged.DW['Ilvl~124+'] 	= set_combine(sets.engaged.DW['Ilvl~122'], 	{ammo="Falcon Eye",neck="Ej Necklace",ear2="Telos Earring",legs=Carmine_legs_HQ})
